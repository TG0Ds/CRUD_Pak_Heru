...
<body>
    ...
    <div class="d-flex justify-content-center">
        <form style="width:75%; margin-top:50px;" action="{{route('pasien.update', $pasien->id)}}" method="post">
        @csrf
        @method('PUT')
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" @error('nama') is-invalid @enderror name="nama" value="{{$pasien->nama}}">
            @error('nama')
...
<input type="text" class="form-control @error('penyakit') is-invalid @enderror" 
       name="penyakit" value="{{ $pasien->penyakit }}">
@error('penyakit')
